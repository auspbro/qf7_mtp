...
usage()
{
echo "Enter  BT_DEVICE/BT_HIGHT_PWR/BT_LOW_PWR/BT_OFF/LE_TEST"
}
rm Q_LEDA_BT.txt
...
elif [ "$item" == "LE_TEST" ]; then
hcitool cmd 0x08 0x001e $channel 0x25 $payload
